...
namespace CatalogDbManager;

internal class CatalogDbInitializer(IServiceProvider serviceProvider, ILogger<CatalogDbInitializer> logger) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        await InitializeDatabase(dbContext, stoppingToken);
    }

    private async Task InitializeDatabase(CatalogDbContext dbContext, CancellationToken stoppingToken)
    {
        ...
        await Seed(dbContext, stoppingToken);

        logger.LogInformation("Database initialization completed after {ElapsedMilliseconds}ms", sw.ElapsedMilliseconds);

    }

    private async Task Seed(CatalogDbContext dbContext, CancellationToken cancellationToken)
    {
